      ...
      >
        ...
        <div className="font-[Montserrat] p-4 md:p-6 overflow-y-auto custom-scrollbar flex-grow">
          <form className="space-y-4 md:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center bg-gray-50 p-4 rounded-2xl border border-dashed border-gray-300">
              <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-[#FFFFFF] rounded-xl p-3 border border-gray-300 shrink-0">
                <img
                  src={pic}
                  alt=""
              ...
              <p className="ml-0 sm:ml-4 mt-2 sm:mt-0 text-xs sm:text-sm lg:text-base font-semibold text-[#363636] text-center sm:text-left">
                <span className="font-medium text-[#0C0C0C]">Drag & Drop</span>{" "}
                your Image Or <br />
                <span className="font-medium text-[#0C0C0C] underline cursor-pointer">
                  Browse file
                </span>{" "}
                on your computer
              </p>
